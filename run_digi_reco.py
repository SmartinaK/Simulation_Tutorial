...
#inputfile = "/eos/user/m/mkoppitz/Public/output_simulations/new_setup_v03/10kruns/ALLEGRO_TESTt_10evt_50GeV_pi0_stripseverywhere.root"     # input file produced with ddsim - can be overridden with IOSvc.Input
#outputfile = "/eos/user/m/mkoppitz/Public/output_simulations/new_setup_v03/10kruns/ALLEGRO_RECO_10evt_50GeV_pi0_stripseverywhere.root"
inputfile = "/eos/user/m/mkoppitz/Public/output_simulations/new_setup_v03/10kruns/LArPb/ALLEGRO_SIM_10000evt_20GeV_photon_nostrips_LAr_Pb.root"     # input file produced with ddsim - can be overridden with IOSvc.Input
outputfile = "/eos/user/m/mkoppitz/Public/output_simulations/new_setup_v03/10kruns/LArPb/ALLEGRO_RECO_10000evt_20GeV_photon_nostrips_LAr_Pb.root"  # output file produced by this steering file - can be overridden with IOSvc.Output
...
parser.add_argument("-i", "--input",  dest="inputfile", help="Path to input ROOT file produced by ddsim", default=inputfile)
parser.add_argument("-o", "--output", dest="outputfile", help="Path for the output ROOT file", default=outputfile)
...
ecalBarrelLayers = 11 
#ecalBarrelSamplingFraction = [0.4480495685672415, 0.14648250727969456, 0.14609631580440938, 0.15057685848445973, 0.15371973323163526, 0.1591629973707858, 0.16547807239705511, 0.16946175920860937, 0.1691059684261927, 0.16916741750547734, 0.1835709054957894] #LKrW
#ecalBarrelSamplingFraction = [0.3938723099929901, 0.20805294957935197, 0.21379376146123893, 0.2233393636029647, 0.2295570021942393, 0.23465766196209487, 0.24145009537974302, 0.24640970549303565, 0.25182410159534807, 0.2560660227336023, 0.30156126580032494] #LKrPb
#ecalBarrelSamplingFraction = [0.3798086335032684, 0.08520039051347549, 0.09627046501750497, 0.0977129984608796, 0.10147751896169371, 0.10491027251444285, 0.1059307492624945, 0.10689857632944268, 0.11149556455254868, 0.11461882723601408, 0.11942280617565132] #LArW
ecalBarrelSamplingFraction = [0.3800493723322256] * 1 + [0.13494147915064658] * 1 + [0.142866851721152] * 1 + [0.14839315921940666] * 1 + [0.15298362570665006] * 1 + [0.15709704561942747] * 1 + [0.16063717490147533] * 1 + [0.1641723795419055] * 1 + [0.16845490287689746] * 1 + [0.17111520115997653] * 1 + [0.1730605163148862] * 1 #LArPb
#ecalBarrelSamplingFraction = [0.09090944598747296, 0.1368302983076818, 0.14547696519715922, 0.15137821087367365, 0.1567890223948759, 0.16049847744156984, 0.1662934195212742, 0.16924596434701972, 0.17492443935929305, 0.1812599707161977, 0.1845838300733824] #1pbLArPb
...
if doTopoClustering:
    ...
    setupTopoClusters(EMBCaloTopoClusterInputs,
                      ...
                      "EMBCaloTopoClusters",
                      0.0,
                      dataFolder + "neighbours_map_ecalB_thetamodulemerged_stripseverywhere.root",
